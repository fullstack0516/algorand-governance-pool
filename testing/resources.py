...
from ally.utils import PendingTxnResponse, wait_for_transaction, get_genesis_accounts
...
#     )
#     signedTxn = txn.sign(sender.get_private_key())
# 
...
#         sp=client.suggested_params(),
#     )
#     signedTxn = txn.sign(account.get_private_key())
# 
#     client.send_transaction(signedTxn)
#     return wait_for_transaction(client, signedTxn.get_txid())
# 
